...
#
# Commands:
#   hubot gtranslate <phrase> - Searches for a translation for the <phrase> and then prints that bad boy out.
#   hubot gtranslate from <source> into <target> <phrase> - Translates <phrase> from <source> into <target>. Both <source> and <target> are optional
...
module.exports = (robot) ->
  ...
  pattern = new RegExp('gtranslate(?: me)?' +
